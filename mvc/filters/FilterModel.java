...
//	
	...
	{
		new DateTimeFilter(this, Filter.DATE_TIME),
		new BoundaryFilter(this, Filter.REDUCE_BOUNDARY),
		new NullsFilter(this, Filter.REMOVE_NULLS),
		new DuplicatesFilter(this, Filter.REMOVE_DUPLICATES),
		new ExpiredFilter(this, Filter.REMOVE_EXPIRED)
	};
