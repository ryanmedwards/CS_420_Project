...
public class DateTimeModel 
{
	...
	protected final JTextField dateField     = new TextField().initColumns(10).initHorizontalAlignment(JTextField.RIGHT).get();
	protected final JTextField timeField     = new TextField().initColumns(10).initHorizontalAlignment(JTextField.RIGHT).get();
	protected final JTextField durationField = new TextField().initColumns(10).initHorizontalAlignment(JTextField.RIGHT).get();
